...
void pir_sensor(void* pvParameters) {
    ...
    if (cause == ESP_SLEEP_WAKEUP_EXT1) {
        ...
        ESP_ERROR_CHECK(mqtt_publish("wify/device01/restroom", "ACT", 1));
        ...
        ESP_ERROR_CHECK(mqtt_publish("wify/device01/restroom", "DEACT", 1));
    ...
    // 초기 부팅, PIR만 세팅
        ...
        ESP_ERROR_CHECK(mqtt_publish("wify/device01/restroom", "LOAD", 1));
